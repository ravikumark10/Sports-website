...
<?php
    ...
    if(isset($_POST['Update'])){
        ...
        $query="update staff set name='$_POST[name]',age='$_POST[age]',email='$_POST[email]',qualify='$_POST[qualify]',special='$_POST[special]',address='$_POST[address]',contact='$_POST[contact]' where id='$_POST[id]' ";
        $result=mysqli_query($conn,$query);
